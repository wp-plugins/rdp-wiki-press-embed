						...
						<div class="help-div">Loads accordion css files on each page of the site.<br /> </div>
                                ...
                                <tr>
                                    ...
                                    <td class="field" style="padding-bottom: 0;"><?php
                                            ...
                                            ?><span style="width: 130px;display: inline-block;">Button Text:</span> <input type="text" name="wikiembed_options[ppe-download-button-text]" id="pp-embed-download-button-text" value="<?php echo $sPPDownloadButtonText ?>" style="width: 250px;" />
                                   </td>
                                </tr>
                                <tr style="line-height: normal;">
                                    ...
                                    <td class="field" style="padding: 0 10px;">
                                        ...
                                        ?>
                                        <span style="width: 130px;display: inline-block;">Width:</span> <input type="text" name="wikiembed_options[ppe-download-button-width]" id="pp-embed-download-button-width" value="<?php echo $sPPDownloadButtonWidth ?>"  style="width: 50px;"/> pixels (max: 500)                                    
                                    </td>
                                </tr>                                
                                <tr>
                                    <th valign="top" style="padding: 0;" class="label" scope="row"></th>
                                    <td class="field" style="padding: 0 10px;">
                                        ...
                                        ?>
                                        <span style="width: 130px;display: inline-block;">Top Color:</span> <input type="text" name="wikiembed_options[ppe-download-button-top-color]" class="bgTopColor rdp-we-color-picker" data-default-color="<?php echo PPE_DOWNLOAD_BUTTON_TOP_COLOR  ?>" value="<?php echo $bgTopColor ?>" />                                        
                                    </td>
                                </tr>
                                <tr>
                                    <th valign="top" style="padding: 0;" class="label" scope="row"></th>
                                    <td class="field" style="padding: 0 10px;">
                                        ...
                                        ?>
                                        <span style="width: 130px;display: inline-block;">Bottom Color:</span> <input type="text" name="wikiembed_options[ppe-download-button-bottom-color]" class="bgBottomColor rdp-we-color-picker" data-default-color="<?php echo PPE_DOWNLOAD_BUTTON_BOTTOM_COLOR  ?>" value="<?php echo $bgBottomColor ?>" />                                        
                                    </td>
                                </tr>
                                <tr>
                                    <th valign="top" style="padding: 0;" class="label" scope="row"></th>
                                    <td class="field" style="padding: 0 10px;">
                                        ...
                                        ?>
                                        <span style="width: 130px;display: inline-block;">Font Color:</span> <input type="text" name="wikiembed_options[ppe-download-button-font-color]" class="fontColor rdp-we-color-picker" data-default-color="<?php echo PPE_DOWNLOAD_BUTTON_FONT_COLOR  ?>" value="<?php echo $fontColor ?>" />                                        
                                    </td>
                                </tr> 
                                <tr>
                                    <th valign="top" style="padding: 0;" class="label" scope="row"></th>
                                    <td class="field" style="padding: 0 10px;">
                                        ...
                                        ?>
                                        <span style="width: 130px;display: inline-block;">Font Hover Color:</span> <input type="text" name="wikiembed_options[ppe-download-button-font-hover-color]" class="fontHoverColor rdp-we-color-picker" data-default-color="<?php echo PPE_DOWNLOAD_BUTTON_FONT_HOVER_COLOR  ?>" value="<?php echo $fontHoverColor ?>" />                                        
                                    </td>
                                </tr>  
                                <tr>
                                    <th valign="top" style="padding: 0;" class="label" scope="row"></th>
                                    <td class="field" style="padding: 0 10px;">
                                        ...
                                        ?>
                                        <span style="width: 130px;display: inline-block;">Border Color:</span> <input type="text" name="wikiembed_options[ppe-download-button-border-color]" class="borderColor rdp-we-color-picker" data-default-color="<?php echo PPE_DOWNLOAD_BUTTON_BORDER_COLOR  ?>" value="<?php echo $borderColor ?>" />                                        
                                    </td>
                                </tr> 
                                <tr>
                                    <th valign="top" style="padding: 0;" class="label" scope="row"></th>
                                    <td class="field" style="padding: 0 10px;">
                                        ...
                                        ?>
                                        <span style="width: 130px;display: inline-block;">Box Shadow Color:</span> <input type="text" name="wikiembed_options[ppe-download-button-box-shadow-color]" class="boxShadowColor rdp-we-color-picker" data-default-color="<?php echo PPE_DOWNLOAD_BUTTON_BOX_SHADOW_COLOR  ?>" value="<?php echo $boxShadowColor ?>" />                                        
                                    </td>
                                </tr> 
                                <tr>
                                    <th valign="top" style="padding: 0;" class="label" scope="row"></th>
                                    <td class="field" style="padding: 0 10px;">
                                        ...
                                        ?>
                                        <span style="width: 130px;display: inline-block;">Text Shadow Color:</span> <input type="text" name="wikiembed_options[ppe-download-button-text-shadow-color]" class="textShadowColor rdp-we-color-picker" data-default-color="<?php echo PPE_DOWNLOAD_BUTTON_TEXT_SHADOW_COLOR  ?>" value="<?php echo $textShadowColor ?>" />                                        
                                    </td>
                                </tr>                                
			</table>
